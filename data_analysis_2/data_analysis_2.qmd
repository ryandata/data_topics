...
format:
  ...
  pdf:
    ...
    papersize: A4
  docx: default
theme: vapor #cerulean #vapor #litera *journal  slate *solar sketchy
include-in-header: 
  text: |
    \usepackage{fvextra}
...
Note the interpretation of these two tests is different. A $p$<.05 for Shapiro implies _rejection_ of normality. A $p$<.05 for K-S is _acceptance_ of normality.
...
```
Note that standardizing the residuals makes a big difference for the Kolmogorov-Smirnow test!
